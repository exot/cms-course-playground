...
\begin{frame}
  ...
  \end{itemize}
    ...
    \end{column}
    \begin{column}{0.45\linewidth}
\movie[width=50mm,height=28mm,poster,externalviewer]{This land is mine. by Nina Paley}{ThisLandIsMine-byNinaPaley.mkv} % https://www.youtube.com/watch?v=4pKMV6e5kEo
    \end{column}
  \end{columns}
